...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.y <=0) {
        [TLPushTransitionDelegate shareInstance].panMix = YES;
        [TLPressTransitionDelegate shareInstance].panMix = YES;
    }else{
        [TLPushTransitionDelegate shareInstance].panMix = NO;
        [TLPressTransitionDelegate shareInstance].panMix = NO;
    }
    [self tlScrollViewDidScroll:scrollView];
}
